...
START TRANSACTION;
USE `info_team08_schema`;
INSERT INTO `info_team08_schema`.`Genre` (`nomGenre`) VALUES ('1');
INSERT INTO `info_team08_schema`.`Genre` (`nomGenre`) VALUES ('2');
INSERT INTO `info_team08_schema`.`Genre` (`nomGenre`) VALUES ('3');
INSERT INTO `info_team08_schema`.`Genre` (`nomGenre`) VALUES ('4');
INSERT INTO `info_team08_schema`.`Genre` (`nomGenre`) VALUES ('5');
INSERT INTO `info_team08_schema`.`Genre` (`nomGenre`) VALUES ('6');
INSERT INTO `info_team08_schema`.`Genre` (`nomGenre`) VALUES ('7');
INSERT INTO `info_team08_schema`.`Genre` (`nomGenre`) VALUES ('8');
