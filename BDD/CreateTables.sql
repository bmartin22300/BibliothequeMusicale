...
DELIMITER $$
USE `info_team08_schema`$$
CREATE PROCEDURE `nouveau_titre` (titre_ VARCHAR(45), dateCreation_ YEAR, genre_ VARCHAR(45))
BEGIN
    ...
    INSERT INTO `info_team08_schema`.`TitreMusical` (`idCatalogue`, `titre`, `dateCreation`, `nomGenre`) /* Creation du titre dans TitreMusical */
											VALUES (idCatalogue_, titre_, dateCreation_, genre_);
END$$
