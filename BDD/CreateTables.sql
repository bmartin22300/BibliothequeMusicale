...
BEGIN
	...
	INSERT INTO `info_team08_schema`.`ElementCatalogue` (`nbEcoute`, `recommande`) VALUES (0, false); /* Creation du titre dans le catalogue */
...
BEGIN
	...
	INSERT INTO `info_team08_schema`.`ElementCatalogue` (`nbEcoute`, `recommande`) VALUES (0, false); /* Creation de l'album dans le catalogue */
    SELECT LAST_INSERT_ID() INTO idCatalogue_; /* On retrouve l'idCatalogue_ */
...
BEGIN
	UPDATE ElementCatalogue SET nbEcoute=0 WHERE idCatalogue != 0;
END$$
...
BEGIN
	UPDATE ElementCatalogue SET nbEcoute = nbEcoute+1 WHERE idCatalogue = idCatalogue_;
END$$
