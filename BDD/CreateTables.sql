...
CREATE TABLE IF NOT EXISTS `info_team08_schema`.`AlbumInterprete` (
  ...
  INDEX `fk_AlbumInterprete_Interprete1_idx` (`Interprete_idInterprete` ASC),
...
DELIMITER $$
USE `info_team08_schema`$$
CREATE PROCEDURE `association_album_interprete` (idCatalogue_ INT, idInterprete_ INT)
BEGIN
	INSERT INTO `info_team08_schema`.`AlbumInterprete` (`Album_Catalogue_idCatalogue`, `Interprete_idInterprete`) VALUES (idCatalogue_, idInterprete_);
END$$
...
DELIMITER $$
USE `info_team08_schema`$$
CREATE PROCEDURE `dissociation_album_interprete` (idCatalogue_ INT, idInterprete_ INT)
BEGIN
