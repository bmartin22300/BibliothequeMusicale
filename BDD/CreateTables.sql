...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `info_team08_schema`.`vue_recommandations` (`idCatalogue` INT, `titre` INT, `dateCreation` INT, `duree` INT, `nomGenre` INT, `recommande` INT);
...
SELECT EC.idCatalogue, titre, dateCreation, duree, nomGenre, recommande
