...
DELIMITER $$
USE `info_team08_schema`$$
CREATE PROCEDURE `nouveau_titre` (titre_ VARCHAR(45), dateCreation_ YEAR, duree_ INT,  genre_ VARCHAR(45))
BEGIN
...
DELIMITER $$
USE `info_team08_schema`$$
CREATE PROCEDURE `modifier_titre` (idCatalogue_ INT, titre_ VARCHAR(45), dateCreation_ YEAR, duree_ INT, nomGenre_ VARCHAR(45))
BEGIN
	UPDATE TitreMusical
...
DELIMITER $$
USE `info_team08_schema`$$
CREATE PROCEDURE `modifier_album` (idCatalogue_ INT, nom_ VARCHAR(45), dateSortie_ YEAR)
BEGIN
	UPDATE Album
