...
public class Utilisateur implements UtilisateurInterface {
	...
	public void regarderElementCatalogue(ElementCatalogue elementCatalogue) {
		...
		//TODO : pour utiliser "CALL regarder(idCatalogue_ INT)", besoin de connaÃ®tre l'identifiant de l'Ã©lÃ©ment du catalogue, ajout attribut que je donne Ã  la crÃ©ation?
