		...
		if(servletPath.equals("/AuthentificationClient")) {
    		...
    		if(servletPath.equals("/GestionPlaylist")) {
    			...
    			System.out.println(userSandbox.authentification(mailAdminMusiqueSandbox, passwordAdminMusiqueSandbox));
    				...
    				adminSandbox.modifierInterprete(interpretesSandbox.get(0), "Noir D�sir","Groupe", "Groupe", Date.valueOf("2001-01-01")); // Modification de "Noir Desir"
    				System.out.println(interpretesSandbox);
    				...
    				System.out.println("Apr�s : " + titresSandbox);
    				System.out.println(interSandbox);
    				adminSandbox.retirerDiscographie(titresSandbox.get(0), interSandbox);
    				System.out.println("Apr�sv2 : " + titresSandbox);
    				System.out.println(interSandbox);
    				...
    				System.out.println(clientSandbox);
    				adminSandboxClient.modifierInformationsClient(clientSandbox, "Un nouveau mail pour la forme", "Un nouveau pass pour la forme", "Mister", "Le", "Plus", dateNaissanceSandbox, "Adress�", styleMusiqueSandbox);
    				System.out.println(clientSandbox);
